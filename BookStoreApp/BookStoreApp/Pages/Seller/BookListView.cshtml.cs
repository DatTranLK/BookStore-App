...
{
    public class BookListViewModel : PageModel
    {
        ...
        public BookListViewModel(IAccountRepository accountRepository, IBookInStoreRepository bookInStoreRepository, IStoreRepository storeRepository)
        {
